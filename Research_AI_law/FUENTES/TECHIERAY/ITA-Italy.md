...
[Tracker](https://www.techieray.com/GlobalAIRegulationTracker#ITA)
...
Italy
Regulation Status
Italy has introduced specific criminal penalties for deepfakes and harmful AI-generated content. Unlawfully disseminating AI-altered audio or video that mislead as to authenticity and cause unjust harm can lead to prison terms of one to five years.
Active monitoring of the AI sector by privacy regulator (the Garante)
Latest Macro Developments

Filter Categories...
[3 March 2026] Italy proposes governance model on AI and work:
...
Human Rights & Ethics
Labor & Workforce
[10 October 2025] Italy's AI bill enters into force:
...
Cybersecurity
Copyright & IP
[23 May 2025] Italian government moves to drop data localization rule in national Al law:
...
[20 March 2025] Italy Senate passes AI bill:
...
Data Privacy & Protection
Cybersecurity
[23 April 2024] Italy's cabinet outlines framework, investment for AI:
...
National Strategy
[23 April 2024] Digital Italy Agency and the National Cybersecurity Agency to supervise AI regulation in Italy:
...
Data Privacy & Protection
[10 April 2024] Italy considers tougher penalties for AI-related crimes:
...
Deepfakes
[12 March 2024] Italy to set up AI fund of 1 billion euros, PM says:
...
Filter Categories...
[29 April 2026] Communications Regulatory Authority files request to European Commission to evaluate Google's AI services over alleged systemic risks to publishers and AI-generated misinformation risks:
The Communications Regulatory Authority (AGCOM) has filed a complaint requesting that the European Commission evaluate Google Ireland's AI services, specifically AI Overviews (AIO) and AI Mode, under the Digital Services Act (DSA), following a report from the Italian Federation of Newspaper Publishers (FIEG) that claimed these AI services have significantly reduced the visibility of editorial content, threatening the economic sustainability of publishers and authors, particularly smaller and independent outlets, while undermining freedom of expression and media plurality. FIEG also expressed concerns that AI-generated responses may contain inaccuracies and lack verifiable sources. AGCOM indicated that an investigation into potential violations by very large online platforms and search engines regarding systemic risk mitigation related to freedom of information and media pluralism may be initiated, and established a permanent discussion forum involving Google, other platforms, and publishers to foster dialogue on copyright, AI, and pluralism protection.

Media & Entertainment
[21 April 2026] Competition Authority concludes investigation into Nova over failure to disclose AI hallucination risks following commitments to improve user information:
The Italian Competition and Market Authority (AGCM) has concluded proceedings against Scaleup, a Turkish company offering NOVA AI chatbox, a cross-platform aggregation service providing access to multiple AI models through a single interface to Italian consumers. The AGCM found that NOVA's commercial practice lacked sufficiently clear information regarding AI "hallucinations”, instances where models generate inaccurate or fabricated information, and the characteristics of free versus paid service versions. To remedy these concerns, the AGCM accepted binding commitments requiring Scaleup to insert prominent disclaimers in Italian warning users to verify AI responses, revise terms and conditions disclosing that the service aggregates existing AI models rather than offering proprietary technology, provide transparent information about subscription plans and service features before purchase, and modify marketing claims to clarify that efficiency derives from aggregating multiple models within a unified interface. Scaleup is also required to fully implement these commitments within sixty days of notification, and the Authority reserves the right to reopen proceedings if the company fails to comply or material circumstances change, with potential fines ranging from EUR 10000 to EUR 10 million for non-compliance.

Antitrust & Competition
Consumer Protection
[8 January 2026] Garante issues warning relating to deepfake risks of Grok, ChatGPT, Clothoff and other similar services:
...
[26 November 2025] Italy antitrust watchdog may curb Meta as WhatsApp AI probe widens:
...
Antitrust & Competition
[1 October 2025] Italian DPA temporarily restricts deepfake nude app ClothOff from processing of Italian personal data:
...
Data Privacy & Protection
Generative AI
[30 July 2025] Italy Competition Authority investigates into Meta's integration of Meta AI in WhatsApp:
...
Antitrust & Competition
Generative AI
[19 May 2025] Garante fines AI company Replika's developer $5.6 million:
...
Data Privacy & Protection
Online Safety & Child Protection
[30 January 2025] Garante blocks DeepSeek:
...
Data Privacy & Protection
[29 January 2025] Garante seeks information from DeepSeek on data protection:
...
Data Privacy & Protection
[20 December 2024] Italian DPA hands down EUR 15 million fine on OpenAI:
...
Cybersecurity
Online Safety & Child Protection
[2 December 2024] Italian Competition Authority launches consultation on pricing algorithms in passenger air transport:
...
Antitrust & Competition
Data Privacy & Protection
[27 November 2024] Italian Garante issues interim ruling on GEDI Gruppo x OpenAI deal:
...
Data Privacy & Protection
Generative AI
[26 September 2024] Italy DPA monitors OpenAI's agreements with publishers:
...
Data Privacy & Protection
Copyright & IP
[21 June 2024] Consumer organisations file privacy complaint to Italian Garante over Linkedin's use of user data for AI training:
...
Data Privacy & Protection
Generative AI
[30 March 2024] Garante issues guidance to protect personal data from web scraping:
...
Generative AI
Cybersecurity
[8 March 2024] Garante investigates OpenAI's AI model Sora:
...
Data Privacy & Protection
Generative AI
[29 January 2024] Garante notifies breaches of privacy law to OpenAI:
...
Data Privacy & Protection
[26 January 2024] Garante fines first city for privacy breaches in use of AI:
...
Data Privacy & Protection
[23 November 2023] Garante looks into online data gathering to train AI:
The Garante has kicked-off a fact-finding investigation into the practice of data scraping for training AI algorithms.

Data Privacy & Protection
Generative AI
[22 May 2023] Garante to launch broad review of AI platforms:
...
Logistics & Infrastructure
[21 May 2024] Seoul Declaration for Safe, Innovative and Inclusive AI signed:
Australia, Canada, the European Union, France, Germany, Italy, Japan, the Republic of Korea, the Republic of Singapore, the United States of America and the United Kingdom signed the Seoul Declaration which (1) aims to promote safe, secure, and trustworthy AI development, (2) addresses global challenges and the protection of human rights, and (3) commits nations to create AI safety institutes and work together on AI safety science, sharing information about AI models, risks, and safety incidents.
...
Filter Categories...
[DRAFT] Provisions and delegation to the Government on artificial intelligence (Senate Act No. 1146):
This bill presents Italy's AI policy, complementary to the EU AI Act. Key points of this bill include: (1) AI in healthcare: improving the National Health System and supporting disease prevention, diagnosis, and treatment; (2) AI in the workplace: enhancing working conditions, protecting workers’ integrity, and increasing productivity; (3) Copyright protection: clarifying rules for AI-generated works and text and data mining; (4) Investment: introducing €1 billion in AI, cybersecurity, quantum computing, and telecommunications; and (5) Content sharing: regulating AI-manipulated content in audiovisual and radio services.
