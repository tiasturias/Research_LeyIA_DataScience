...
[Tracker](https://www.techieray.com/GlobalAIRegulationTracker#NZL)
...
New Zealand
Regulation Status
No comprehensive, binding AI-specific regulation in force as of mid-2025. Existing approach is sectoral and principle-based, relying on voluntary frameworks, guidance, and alignment with OECD AI Principles. Government has signaled intent for a light-touch, risk-based regulatory approach, with public consultation on a national AI strategy and further legislative review expected in 2025. Privacy and data protection laws are being updated to address AI and biometrics, but these are not AI-specific.
Algorithm Charter and Responsible AI Guidance exist for public sector and businesses, but are non-binding.
Latest Macro Developments

Filter Categories...
[8 July 2025] New Zealand releases AI strategy and business guidance:
The New Zealand Government, through the Ministry of Business, Innovation and Employment, has released the New Zealand AI Strategy and the Responsible AI Guidance of Businesses. The AI Strategy calls for a "light-touch, principles-based policy aligned with OECD AI Principles to address regulatory uncertainty". The Guidance provides practical, voluntary guidance that outlines good practices and actions that can support firms’ successful adoption of AI.

Data Privacy & Protection
Generative AI
[7 February 2025] NZ MPs get behind-the-scenes DeepSeek warning:
It is reported that New Zealand's Parliament has issued a strong warning against using DeepSeek on government devices pending a security review, though it has not yet implemented a ban. However, experts are urging the New Zealand government to follow Australia's lead in banning DeepSeek on government devices and instructing critical infrastructure operators to restrict access, citing concerns about data collection.

Cybersecurity
Data Privacy & Protection
[3 February 2025] New Zealand releases guidance for safe use of AI in the public sector:
The New Zealand Government has released guidelines which supports leaders, decision-makers and those in the New Zealand Public Service working or planning to work with generative AI. It enables agencies to explore and adopt GenAI systems in ways that are safe, transparent and responsible, and which effectively balance risks with potential benefits of these systems. This guidance is part of the suite of Responsible AI Guidance for the Public Service which is being developed by the Government Chief Digital Officer to support the safe uptake of AI technology across government.

Generative AI
Data Privacy & Protection
Cybersecurity
[23 October 2024] New Zealand government adopts Bletchley Declaration:
The New Zealand government has adopted the Bletchley Declaration on AI safety, which was already signed by 28 other countries. In its press release, it has also been revealed that: (1) the Ministry of Business, Innovation and Employment has developed an initial cross-portfolio which focuses on policy changes; (2) the Department of Internal Affairs’ Government Chief Digital Officer is leading work to support public sector agencies to explore safe use of AI for efficiency and service delivery improvements; and (3) the Government will in 2025 consult publicly on a national AI strategy.

Generative AI
Data Privacy & Protection
Cybersecurity
[25 July 2024] MBIE releases cabinet paper on AI, indicating a light-touch risk-based approach to regulating AI :
The New Zealand Ministry of Business, Innovation and Employment (MBIE) has released their recent cabinet paper which sets out the government’s high-level approach to AI in New Zealand. Key points of the paper include (1) a commitment to a light-touch, proportionate, and risk-based approach to AI regulation, (2) the promotion of the OECD AI Principles as a key direction for responsible AI, (3) the role of the Government Chief Digital Officer in leading AI innovation in public services, (4) the need for international engagement to shape AI norms, and (5) the importance of coordinating AI work across government agencies to unlock AI’s potential for innovation, productivity, and public service improvement.

Sandbox
Data Privacy & Protection
[29 January 2024] New Zealand government looking to get up to speed on AI regulation:
Science, Technology and Innovation Minister Judith Collins revealed to a news outlet (Newstalk ZB) that the New Zealand Government will restart a parliamentary caucus on the topic of AI regulation, including revising a draft AI framework from the Department of Internal Affairs.

National Strategy
Sector Developments

Filter Categories...
[18 December 2024] New Zealand Privacy Commissioner releases Biometrics Code for public consultation:
The Privacy Commissioner has launched a consultation on a new draft Biometrics Code, which proposes to modify some of the principles in the Privacy Act and create more specific privacy rules for agencies using biometric technologies to collect and process biometric information. The major additional rules in the Code are: (1) adding a requirement to do a proportionality test and put in place privacy safeguards; (2) stronger notification and transparency obligations; and (3) limits on some uses of biometric information (e.g. emotion analysis and types of biometric categorisation). The consultation is open through March 2025, with the Code expected to come into force later in 2025.

Data Privacy & Protection
[3 April 2024] NZ Privacy Commissioner wants privacy laws tightened to cover biometrics and AI:
Privacy Commissioner Michael Webster is looking at new rules - and possible legislation - to cover biometrics and AI, and is calling for agencies and businesses to make privacy a focus. The move comes amid a record surge in privacy complaints of 79 percent within the last financial year. One of the most high-profile cases is facial recognition technology trials conducted by grocery cooperative Foodstuffs which plans to implement the technology in 25 stores over a period of six months to combat retail crime. The Privacy Commissioner has started investigation into Foodstuff's facial recognition trial, examining its compliance with the country's Privacy Act.
...
National AI strategy which calls for a "light-touch, principles-based policy aligned with OECD AI Principles to address regulatory uncertainty".

Public Sector & Governance
Acts, Bills & Reforms

Filter Categories...
Deepfake Digital Harm and Exploitation Bill (2025):
...
Filter Categories...
Responsible AI Guidance for Businesses (2025):
A voluntary resource for guiding businesses (including sole traders, non-profits and individual professionals) to realise AI's benefits through using and developing AI systems in a trustworthy way. The Guidance outlines various types of considerations that businesses can take into account when using or developing AI systems. These include potential risks to: cybersecurity; privacy; human rights; workplace culture; the environment; intellectual property and creators; and physical safety.

Cybersecurity
Data Privacy & Protection
Copyright & IP
Public Service AI Framework:
A framework supporting the responsible use of AI technologies across the New Zealand Public Service. The framework (1) sets a vision for AI in New Zealand’s Public Service; (2) defines 5 key principles to guide Public Service AI use; (3) outlines the policy context for Public Service AI use; and (4) outlines 6 key pillars of the Government Chief Digital Officer’s (GCDO) AI work programme.

Generative AI
Data Privacy & Protection
Responsible AI Guidance for the Public Service - GenAI:
Guidelines which supports leaders, decision-makers and those in the New Zealand Public Service working or planning to work with generative AI. It enables agencies to explore and adopt GenAI systems in ways that are safe, transparent and responsible, and which effectively balance risks with potential benefits of these systems. This guidance is part of the suite of Responsible AI Guidance for the Public Service which is being developed by the Government Chief Digital Officer to support the safe uptake of AI technology across government.

Generative AI
Data Privacy & Protection
Algorithm Charter for New Zealand (2020):
This Charter provides a risk matrix to assess the likelihood and impact of algorithmic applications. The New Zealand government generally prioritizes trustworthy and human-centric AI development.
